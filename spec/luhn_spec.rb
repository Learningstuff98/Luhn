...
RSpec.describe Luhn, type: :model do
  describe 'valid? should work' do
    ...
    it 'should be false for this number from codewars' do 
      expect(Luhn.valid?(1234567890123456)).to be false
    end

    it 'should be true for this number from codewars' do 
      expect(Luhn.valid?(4408041234567893)).to be true
    end

    it 'should be true for this number from codewars' do 
      expect(Luhn.valid?(38520000023237)).to be true
    end

    it 'should be true for this number from codewars' do 
      expect(Luhn.valid?(4222222222222)).to be true
    end
  end
end
